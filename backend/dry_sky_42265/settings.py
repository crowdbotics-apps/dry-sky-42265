"""
Django settings for dry_sky_42265 project.
...
ROOT_URLCONF = 'dry_sky_42265.urls'
...
WSGI_APPLICATION = 'dry_sky_42265.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dry_sky_42265 API",
    "DESCRIPTION": "API documentation for dry_sky_42265 App",
    "VERSION": "v1",
}
